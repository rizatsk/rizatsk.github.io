    ...
    divFormContact.innerHTML = `
        <div
            ...
            <div class="group form">
                <label class="text-dark text-base capitalize" for="name">${formContact.name.label}: </label>
                <input type="text" id="name" name="name" placeholder="${formContact.name.placeholder}"
            ...
            <div class="group form">
                <label class="text-dark text-base capitalize" for="email">${formContact.email.label}: </label>
                <input type="email" id="email" name="email" placeholder="${formContact.email.placeholder}"
                    class="w-full rounded-[8px] py-3 pl-2 mt-1 text-sm border-b-2 focus:outline-none focus:ring-indigo-400 focus:ring-1 focus:border-indigo-400"
                    required>
            </div>
            <div class="group form">
                <label class="text-dark text-base capitalize" for="phone">${formContact.phone.label}:</label>
                <input type="number" id="phone" name="phone"
                    class="w-full rounded-[8px] py-3 pl-2 mt-1 text-sm border-b-2 focus:outline-none focus:ring-indigo-400 focus:ring-1 focus:border-indigo-400"
                    placeholder="${formContact.phone.placeholder}" required>
            </div>
            <div class="group form">
                <label class="text-dark text-base capitalize" for="message">${formContact.message.label}: </label>
            ...
            <div class="self-end">
                <button type="submit"
                    class="2xl:text-lg bg-gradient-primary px-7 py-3 rounded-lg text-white capitalize">${formContact.button}</button>
            </div>
        </div>
    `;
