...
$('#send').on('click', function () {
  ...
  if ("" != message && "" != nama) {
    /* Final Whatsapp URL */
    var blanter_whatsapp = walink + '?phone=' + phone + '&text=' + walink2 + '%0A%0A' + 'Name : ' + nama + '%0A' + 'Email Address : ' + email + '%0A' + 'Phone : ' + phone_user + '%0A' + 'Message : ' + message + '%0A';
